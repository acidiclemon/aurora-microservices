...
# -----------------------------------------------------------------------------
# Networking — Firewall VPC
# -----------------------------------------------------------------------------

variable "firewall_vpc_cidr" {
  description = "CIDR block for the Firewall VPC (hosts AWS Network Firewall endpoints)"
  type        = string
  default     = "10.112.0.0/16"
}

# -----------------------------------------------------------------------------
# Networking — Egress VPC
# -----------------------------------------------------------------------------

variable "egress_vpc_cidr" {
  description = "CIDR block for the Egress VPC (hosts NAT Gateways for internet access)"
  type        = string
...
# -----------------------------------------------------------------------------
# Okta Domain (used by DNS Firewall and Network Firewall rules)
# -----------------------------------------------------------------------------

variable "okta_domain" {
  description = "The bare Okta tenant domain (e.g. dev-12345678.okta.com). Used to build DNS and Network Firewall allow-lists."
  type        = string
}
